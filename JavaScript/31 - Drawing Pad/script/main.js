...
window.onload = () => {
    var c = document.querySelector("#defaultCanvas");
    ...
    document.querySelector("#defaultCanvas").addEventListener("mousedown", (e) => {
        x1 = e.clientX;
        y1 = e.clientY - 42;
        isDown = true
    });

    document.querySelector("#defaultCanvas").addEventListener("mousemove", (e) => {
        if (isDown) {
    ...
    document.querySelector("#defaultCanvas").addEventListener("mouseup", (e) => {
        isDown = false;
        drawing(e);
        dataURL = canvas.toDataURL();
    });
    ...
    function drawing(e) {
        if (line.checked) {
            ...
            if (document.querySelector("#gradient").checked) {
                ...
                gradient.addColorStop(e, colorInput.value);
