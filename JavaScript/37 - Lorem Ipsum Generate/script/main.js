...
function loremIpsum(size) {
    ...
    const lorem = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vehicula odio non risus finibus feugiat.
                    Donec bibendum, sapien eget volutpat dapibus, urna velit malesuada tortor, et fermentum arcu velit non dui. Vestibulum condimentum, justo sed rhoncus laoreet, nunc tellus viverra nulla, nec eleifend purus velit non justo. 
...
copy.addEventListener('click', () => {
    ...
    textArea.value = text; // 텍스트 영역의 값 설정
    ...
    document.body.removeChild(textArea); // 텍스트 영역을 문서에서 제거
});
